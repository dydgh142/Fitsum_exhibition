...
class PosenetActivity :
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    //여기 수정해야함 계속 디폴트 값으로 받아와짐 데이터가 제대로 안넘어 오는듯.
    //캐릭터 옷 변경하고나서 자세 바뀌는거 보여줄거면 여기서 바꿔야함.
    val gintent = Intent()
    Item = gintent.getIntExtra("userItem",5)
      ...
      val builder = AlertDialog.Builder(activity)
        ...
        .setPositiveButton("종료"){ dialog, which ->
          ...
          if (Item == 1 || Item == 2 || Item == 3) {
            nextIntent.putExtra("userItem", 3);
          } else if (Item == 4 || Item == 5 || Item == 6) {
            nextIntent.putExtra("userItem", 6);
          } else if (Item == 7 || Item == 8 || Item == 9) {
            nextIntent.putExtra("userItem", 9);
          } else if (Item == 10 || Item == 11 || Item == 12) {
            nextIntent.putExtra("userItem", 12);
          } else if (Item == 13 || Item == 14 || Item == 15) {
            nextIntent.putExtra("userItem", 15);
          } else if (Item == 16 || Item == 17 || Item == 18) {
            nextIntent.putExtra("userItem", 18);
          }
    ...
    fin_pushup?.setOnClickListener {
      ...
      val builder = AlertDialog.Builder(activity)
        ...
        .setPositiveButton("종료"){ dialog, which ->
          ...
          val nextIntent = Intent(context, MainActivity::class.java)
          if (Item == 1 || Item == 2 || Item == 3) {
            nextIntent.putExtra("userItem", 2);
          } else if (Item == 4 || Item == 5 || Item == 6) {
            nextIntent.putExtra("userItem", 5);
          } else if (Item == 7 || Item == 8 || Item == 9) {
            nextIntent.putExtra("userItem", 8);
          } else if (Item == 10 || Item == 11 || Item == 12) {
            nextIntent.putExtra("userItem", 11);
          } else if (Item == 13 || Item == 14 || Item == 15) {
            nextIntent.putExtra("userItem", 14);
          } else if (Item == 16 || Item == 17 || Item == 18) {
            nextIntent.putExtra("userItem", 17);
          }
          startActivity(nextIntent)
        }
        .setNegativeButton("취소",null).show()
